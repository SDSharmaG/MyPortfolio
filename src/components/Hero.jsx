      ...
      <div className="container py-3 py-md-5">
        <div className="row align-items-center g-4 g-lg-5">
          ...
          <div className="col-lg-6 order-lg-1 order-2">
            {/* Available Badge */}
            <div className="d-inline-flex align-items-center border border-info rounded-pill px-3 py-2 mb-4" style={{ background: 'var(--bg-card)',marginTop:"20px" }}>
              <span className="status-dot-pulse me-2"></span>
              <span className="text-info fw-semibold small text-uppercase" style={{ letterSpacing: '0.5px' }}>Open to Opportunities</span>
            </div>

            <h1 className="display-4 display-md-3 fw-bold mb-3">
              Hi, I'm <span className="text-info">Shankar</span>
            </h1>
            <h2 className="h4 h-md-3 mb-4" style={{ color: 'var(--text-secondary)' }}>
              Full Stack <span className="text-info">MERN Developer</span>
            </h2>
            
            <p className="lead mb-4" style={{ color: 'var(--text-muted)', fontSize: '1rem' }}>
              Building production-ready web applications with modern technologies. 
              <span className="d-block mt-2">3+ projects delivered | Available for immediate joining</span>
            </p>
            ...
            <div className="d-flex gap-3 flex-wrap justify-content-center justify-content-lg-start">
              <a href="#projects" className="btn btn-info rounded-pill px-3 px-md-4 py-2 py-md-3 fw-semibold">
                <i className="bi bi-grid-3x3-gap-fill me-2"></i>View Portfolio
              </a>
              <a href="#contact" className="btn btn-outline-info rounded-pill px-3 px-md-4 py-2 py-md-3 fw-semibold">
          ...
          <div className="col-lg-6 order-lg-2 order-1 text-center " style={{marginTop:"80px"}}>
            <div className="position-relative d-inline-block mx-auto">
              ...
              <div className="position-relative rounded-4 p-1 p-md-2" style={{ 
              ...
              <div className="position-absolute rounded-pill px-3 px-sm-4 py-1 py-sm-2 shadow-lg d-flex align-items-center gap-1 gap-sm-2" style={{ 
                bottom: '-5px', 
                right: '-5px',
                ...
                <i className="bi bi-check-circle-fill text-info" style={{ fontSize: 'clamp(0.8rem, 4vw, 1.2rem)' }}></i>
                <span className="fw-semibold" style={{ fontSize: 'clamp(0.65rem, 3vw, 0.8rem)' }}>Available Now</span>
              </div>
              ...
              <div className="position-absolute rounded-pill px-3 px-sm-4 py-1 py-sm-2 shadow-lg d-flex align-items-center gap-1 gap-sm-2" style={{ 
                ...
                <i className="bi bi-star-fill text-info" style={{ fontSize: 'clamp(0.8rem, 4vw, 1.2rem)' }}></i>
                <span className="fw-semibold" style={{ fontSize: 'clamp(0.65rem, 3vw, 0.8rem)' }}>Top Talent</span>
              </div>
            </div>
          </div>
        </div>
