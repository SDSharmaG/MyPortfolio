  ...
  const projectList = [
    {
      ...
      description:
        "Full-stack MERN application for real-time EV charging slot booking with secure authentication, RESTful APIs, and dynamic React UI.",
      features: [
        "JWT Authentication",
      ...
      githubLink:
        "https://github.com/SDSharmaG/Ev_Charger_Booking_System_Puducherry",
    ...
    },
    {
      ...
      description:
        "Responsive single-page e-commerce app with product listing, filtering, cart functionality, and reusable components.",
      features: [
        "Product Filtering",
        "Cart Management",
        "Responsive UI",
    ...
    },
    {
      ...
      description:
        "Modern responsive web interfaces focusing on layout design, styling, and cross-device compatibility.",
      features: [
        "Modern Layout",
        "Responsive Design",
      ...
      <div className="container py-5">
            ...
            <div className="col-md-6 col-lg-4" key={index}>
              <div className="card glass-card border-0 h-100 project-card">
                <div className="card-body d-flex flex-column p-4">
                  ...
                  <h5
                    className="card-title fw-bold text-info mb-3"
                  ...
                  <div className="mb-3">
                    <div className="d-flex flex-wrap gap-2">
                      {project.stack.map((tech, techIdx) => (
                        <span key={techIdx} className="tech-badge small">
                          {tech}
                        </span>
                      ))}
                    </div>
                    ...
                    >
                      {project.features.slice(0, 3).map((feature, fIdx) => (
                        <li key={fIdx} className="mb-1">
                          <i
                            className="bi bi-check-circle-fill text-info me-2"
                  ...
                  <div className="mt-auto pt-3 d-flex gap-3">
                    <a
                      ...
                      className="btn btn-outline-info rounded-pill px-3 py-2 flex-grow-1"
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="btn btn-info rounded-pill px-3 py-2 flex-grow-1"
                      style={{ fontSize: "0.85rem" }}
                    >
        ...
        <div className="text-center mt-5">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="btn btn-outline-info rounded-pill px-5 py-3 fw-semibold"
          >
